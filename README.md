...
## What we did to ensure security in our login system
- Verifying the user inputs
- Making use of prepared statements to avoid SQL injections

- <i>For my own safety and convenience, the passwords committed along with the code are only for demonstration purposes, they are not real passwords</i>.
...
* MySQL Workbench
* Claude.ai for style and responsiveness of the website
